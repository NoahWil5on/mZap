...
import { NavController, NavParams, AlertController, ViewController, LoadingController, Slides, ModalController } from 'ionic-angular';
...
export class ResolveComponent {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController,
            ...
            public click: ClickProvider, public userInfo: UserInfoProvider, public infoComponent: InfoComponent) {
    this.images.doClear();
